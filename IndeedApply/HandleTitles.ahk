...
HandleIndeedTitles(script := "", titleCheck := "", timeout := 5000, checkInterval := 50, titles := [], keywordSearchTitles := []) {
    ...
    global screenerQuestionsTitle := "Answer screener questions from the employer | Indeed.com - Google Chrome",
        ...
        applicationPreScreenTitle := "Application pre-screen | Indeed.com - Google Chrome",
        ...
        ignoredWindowTitleC := "Add or update your contact information | Indeed.com - Google Chrome",
    ...
    { title: applicationPreScreenTitle, label: "applicationPreScreenTitle" },
    ...
    { title: ignoredWindowTitleC, label: "ignoredWindowTitleC" },
    ...
    global indeedWindowTitleFunctionMap := Map(
        ...
        "applicationPreScreenTitle", HandleIndeedApply,
        ...
        "ignoredWindowTitleC", HandleIgnoredTitles,
    ...
    ; If no matching title is found, search for jobs
    SearchForJobs()

    ; Since no matching title is found, log and return "jobSearchTitle"
